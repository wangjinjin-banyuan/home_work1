...
public class Staff {
  ...
  public Staff() {
    ...
    staffList[6] = new Commission("小李","高淳","13456779878","876-23-4567",6.25,0.20);
    staffList[7] = new Commission("小王","溧水","15567890543","765-54-8756",9.75,0.15);
    ((Executive) staffList[0]).awardBonus(500.00);
    ((Hourly) staffList[3]).addHours(40);
    ((Commission)staffList[6]).addSales(35,400);
    ((Commission)staffList[7]).addSales(40,950);
