        ...
        <div class="log_c">
            ...
            <form action="login.do" method="post">
                <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="70">
                        <td>用户名</td>
                        <td><input name="loginName" type="text" value="<%=loginName%>" class="l_user" /></td>
                    </tr>
                    <tr height="70">
                        <td>密&nbsp; &nbsp; 码</td>
                        <td><input name="password" type="password" value="<%=password%>" class="l_pwd" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td style="font-size:12px; padding-top:20px;">
                	<span style="font-family:'宋体';" class="fl">
                    	<label class="r_rad"><input type="checkbox"  name="remember"/></label><label class="r_txt">请保存我这次的登录信息</label>
                    </span>
