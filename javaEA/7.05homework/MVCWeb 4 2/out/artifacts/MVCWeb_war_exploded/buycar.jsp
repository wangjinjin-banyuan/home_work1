...
<div class="soubg">
    <div class="sou">
      ...
      <%
          ...
          if(object2 != null){
              User a = (User)object2;
              out.print("欢迎，<a href=\"Member.jsp\" >" + a.getLoginName()+"</a>");
    ...
    <div class="content mar_20">
        ...
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
            ...
            <%
                ...
                count+=(product.getPrice()*(cart.get(product)));
                }
            %>
            <tr height="70">
            ...
            <tr valign="top" height="150">
                <td colspan="6" align="right">
                    <a href="#"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; <a href="order.do?cost=<%=count%>&serialNumber=2020070512345"><img src="images/buy2.gif" /></a>
                </td>
            </tr>
        </table>
