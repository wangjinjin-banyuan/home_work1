        ...
        <div class="reg_c">
            <form action="regist.do" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <%
                        if(!(request.getAttribute("password").equals(request.getAttribute("confim")))){
                            out.print("两次密码不一致，请重新注册");
                        }

                    %>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;确认密码 &nbsp;</td>
                        <td><input type="password" name="confirm" value="" class="l_pwd" /></td>
                    </tr>
                    <tr height="50">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="text" name="mobil" value="" class="l_tel" /></td>
                    </tr>
                    <tr height="50">
                        <td align="right">邀请人会员名 &nbsp;</td>
                        <td><input type="text" name="people" value="" class="l_mem" /></td>
                    </tr>
                    <tr height="50">
                        <td align="right">邀请人ID号 &nbsp;</td>
                        <td><input type="text" name="peopleId" value="" class="l_num" /></td>
                    </tr>
                    <tr height="50">
