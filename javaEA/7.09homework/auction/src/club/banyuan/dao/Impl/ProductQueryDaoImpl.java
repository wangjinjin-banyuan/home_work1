...
public class ProductQueryDaoImpl extends BaseDaoImpl implements ProductQueryDao {


  public ProductQueryDaoImpl(Connection connection) {
    super(connection);
  }
  ...
  public Product tableToClass(ResultSet rs) throws Exception {
     Product product = new Product(rs.getInt(1),rs.getString(2),rs.getString(3),
         rs.getTime(4),rs.getTime(5),rs.getFloat(6));
    return product;
  }
