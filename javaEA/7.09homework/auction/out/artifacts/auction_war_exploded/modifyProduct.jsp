...
<div class="wrap">
    ...
    <div class="login logns produce">
        ...
        <dl>
            <dd >
                <label>名称：</label>
                <input type="text" name="p_name" class="inputh lf" value="名称" />
                <div class="xzkbg spbg lf"></div>
            </dd>
            <dd>
                <label>起拍价：</label>
                <input type="text" name="p_startingPrice" class="inputh lf" value="4000,00" />
                <div class="lf red laba">必须为数字</div>
            </dd>
            <dd>
                <label>底价：</label>
                <input type="text" name="p_floorPrice" class="inputh lf" value="5000.00" />
                <div class="lf red laba">必须为数字</div>
            </dd>
            <dd>
                <label>开始时间：</label>
                <input type="text" name="p_startTime" class="inputh lf" value="2010-01-05 12:30:00" />
                <div class="lf red laba">格式：2011-05-05 12:30:00</div>
            </dd>
            <dd>
                <label>结束时间：</label>
                <input type="text" name="p_endTime" class="inputh lf" value="2010-05-06 12:30:00" />
                <div class="lf red laba">格式：2011-05-05 12:30:00</div>
            </dd>
            <dd class="dds">
                <label>描述：</label>
                <textarea name="p_describle" cols="" rows="" class="textarea">嘿嘿</textarea>
            </dd>
            <dd>
                <label>修改图片：</label>
