        ...
        <div class="sidebarg fnone">
            <form action="adminLogin.do" method="post" target='_blank'>
                <div class="login">
                    <dl>
                        <dt>管理员登陆</dt>
                        <dd><label for="name">用户名：</label><input type="text"  name="adminName" class="inputh" value="常用邮箱" id="name"/></dd>
                        <dd><label for="password">密 码：</label><input type="text"  name="a_password" class="inputh" value="密码" id="password"/></dd>
                        <dd>
